...
import { Calendar, Clock, MapPin, Ticket, Download, CheckCircle, ChevronRight, Mail, Sparkles, Lock, ShieldCheck, Users, DollarSign, Send, Image as ImageIcon, Loader2, Shield } from 'lucide-react';
          ...
          <div className="bg-[#0a0102] border border-red-900/50 p-8 rounded-2xl max-w-sm w-full shadow-[0_0_50px_rgba(212,175,55,0.1)] relative">
            ...
            <form onSubmit={handleAdminAuth}>
              ...
              <div className="flex space-x-3">
                ...
                <button type="submit" className="w-2/3 py-3 bg-gradient-to-r from-[#D4AF37] to-[#8B6508] text-black font-bold rounded-lg uppercase text-xs tracking-widest hover:brightness-110 transition-all flex items-center justify-center space-x-2">
                  <span>Unlock</span>
            ...
            <div className="w-full max-w-5xl relative group animate-fade-in print-hide">
              ...
              <div className="relative w-full bg-[#0a120a]/90 border border-green-900/40 backdrop-blur-2xl rounded-3xl p-8 md:p-10 shadow-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                  ...
                  <div className="bg-black/40 border border-green-900/30 p-6 rounded-2xl flex items-center space-x-4"><Users className="text-green-500" size={32} /><div><p className="text-xs text-gray-500 uppercase tracking-widest">Guest List Groups</p><p className="text-2xl font-light text-white">{ticketDatabase.length}</p></div></div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                  ...
                  <div className="lg:col-span-2">
                    <h3 className="text-sm font-medium uppercase tracking-widest text-green-400 mb-4">Database</h3>
                    <div className="bg-black/40 border border-green-900/20 rounded-2xl overflow-hidden max-h-[300px] overflow-y-auto">
                  ...
                  <div className="lg:col-span-3 bg-black/40 border border-green-900/20 p-6 rounded-2xl mt-4">
                    <h3 className="text-sm font-medium uppercase tracking-widest text-green-400 mb-6 flex items-center gap-2"><Lock size={16} /> Advanced Controls</h3>
                    ...
                    <div className="mt-8 pt-6 border-t border-green-900/30 flex justify-end"><button onClick={handleFactoryReset} className={`text-xs border px-6 py-3 rounded-lg transition-all ${confirmReset ? 'bg-red-900 text-white' : 'text-red-500 border-red-900/30'}`}>{confirmReset ? "Confirm Reset" : "Factory Reset Local"}</button></div>
                  </div>
                </div>
              </div>
            </div>
